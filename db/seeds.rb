brand1 = Brand.create(name: "テスト")
brand2 = Brand.create(name: "シャネル")
brand3 = Brand.create(name: "ルイ・ヴィトン")
brand4 = Brand.create(name: "ナイキ")
brand5 = Brand.create(name: "アディダス")
brand6 = Brand.create(name: "シュプリーム")
brand7 = Brand.create(name: "エルメス")
brand8 = Brand.create(name: "プラダ")
brand9 = Brand.create(name: "クリスチャン・ディオール")
brand10 = Brand.create(name: "イヴ・サンローラン")
brand11 = Brand.create(name: "ロエベ")
brand12 = Brand.create(name: "セリーヌ")
brand13 = Brand.create(name: "クロエ")
brand14 = Brand.create(name: "ティファニー")
brand15 = Brand.create(name: "ユニクロ")
brand16 = Brand.create(name: "プーマ")
brand17 = Brand.create(name: "リーバイス")
brand18 = Brand.create(name: "グローバルワーク")
brand19 = Brand.create(name: "ギャップ")
brand20 = Brand.create(name: "ナノユニバース")
brand21 = Brand.create(name: "ポールスミス")
brand22 = Brand.create(name: "ラルフローレン")
brand23 = Brand.create(name: "ディーゼル")
brand24 = Brand.create(name: "その他")
